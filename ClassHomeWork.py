...
#Студенты
student_1 = Student('Сергей', 'Огурцов', 'муж')
student_1.finished_courses += ['Git']
student_1.courses_in_progress += ['Python']

student_2 = Student('Яна', 'Печкина-Лавочкина', 'жен')
student_2.finished_courses += ['Git']
student_2.courses_in_progress += ['Python']

# Лекторы
lecturer_1 = Lecturer('Дон', 'Кихот')
lecturer_1.courses_attached += ['Python']
lecturer_2 = Lecturer('Дона', 'Роза')
lecturer_2.courses_attached += ['Python']

# Проверяющие
reviewer_1 = Reviewer('Пётр', 'Дудочкин')
reviewer_1.courses_attached += ['Python']
reviewer_2 = Reviewer('Прасковья', 'Герц')
